...
SELECT
    ...
    alert_created_at,
    alert_updated_at,
    -- Duration in days, minimum 1. If start is epoch default (1970-01-01), fall back to created date.
    -- End date defaults to today for ongoing alerts with no end date.
